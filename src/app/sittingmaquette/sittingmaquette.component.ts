...
@Component({
  selector: 'app-sittingmaquette',
  templateUrl: './sittingmaquette.component.html',
  styleUrls: ['./sittingmaquette.component.css']
})
export class SittingmaquetteComponent implements OnInit {
